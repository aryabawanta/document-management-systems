                        ...
                        <?php echo form_open_multipart($path . $class . '/' . (isset($id) ? 'update/' . $id : 'create'), array('id' => 'form_data')) ?>
                            <div class="col-sm-8">
                                <div class="row form-group">
                                    <label class="col-sm-4 col-form-label hidden-xs-down">Code</label>
                                    <small class="m-l-15 hidden-sm-up">Code</small>
                                    <div class="col-sm-8">
                                        ...
                                        <a class="mytooltip" href="javascript:void(0)"> 
                                            ...
                                            <span class="tooltip-content5">
                                                <span class="tooltip-text3">
                                                    <span class="tooltip-inner2">Klasifikasi diatasnya sesuai dengan Struktur Klasifikasi
                                                    </span>
                                                </span>
                                            </span>
                                        </a>
