        ...
        switch ($action) {
            case self::ACTION_POST_CREATE:
                ...
                if (!empty($post['images'])) {
                    $message = 'memposting gambar "' . Image::getName($post['images'][Image::IMAGE_ORIGINAL]['link']) . '"';
            ...
            case self::ACTION_COMMENT_CREATE:
                ...
                $comment = $this->Comment_model->with(array('Post' => array('Group' => 'Group_member')))->get($referenceId);
